...
export const SingleReservationSchema = z.object({
  createUser: z.string(),
...
export const SingleReservationResponseSchema = z.object({
  item: SingleReservationSchema,
  status: z.string(),
  message: z.string(),
  includesOperationalMessage: z.boolean(),
})
...
export type SingleReservationResponse = z.infer<
  typeof SingleReservationResponseSchema
>
